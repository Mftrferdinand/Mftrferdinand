...
# Background: BIRU SOLID (#2563eb / #225bd8 royal blue)
BLUE = (37, 99, 235, 255)
...
print(f"Rendering {TOTAL_FRAMES} frames on solid blue background...")
...
for gi in range(TOTAL_FRAMES):
    ...
    frames.append(
        final_frame.convert("RGB").quantize(colors=64, method=Image.FASTOCTREE, dither=Image.Dither.NONE)
    )
...
print("Finished saving blue banner to:", out_path)
